...
| [magisk-boot-modules.md](magisk-boot-modules.md) | **Loading a kernel module at boot** so a panel-free puck tracks from a cold start with no host involvement. The four silent failures between a stock headset and a working `post-fs-data`. |
